...
///     "windows-1255" and "x-mac-hebrew" are two different proper super sets of
...
internal class HebrewProber : CharsetProber
{
    ...
    private const byte PR_FINAL_KAF = 0xEA;
    private const byte PR_NORMAL_KAF = 0xEB;
    private const byte PR_FINAL_MEM = 0xED;
    private const byte PR_NORMAL_MEM = 0xEE;
    private const byte PR_FINAL_NUN = 0xEF;
    private const byte PR_NORMAL_NUN = 0xF0;
    private const byte PR_FINAL_PE = 0xF3;
    private const byte PR_NORMAL_PE = 0xF4;
    private const byte PR_FINAL_TSADI = 0xF5;

    // Minimum Visual vs Logical final letter score difference.
    // If the difference is below this, don't rely solely on the final letter score distance.
    private const int PR_MIN_FINAL_CHAR_DISTANCE = 5;

    // Minimum Visual vs Logical model score difference.
    // If the difference is below this, don't rely at all on the model score distance.
    private const float PR_MIN_MODEL_DISTANCE = 0.01f;
    ...
    public override string GetCharsetName()
    {
        ...
        switch (finalSub)
        {
            case >= PR_MIN_FINAL_CHAR_DISTANCE:
            ...
            default:
            {
                ...
                return modelSub switch
                {
                    > PR_MIN_MODEL_DISTANCE => LOGICAL_HEBREW_NAME,
                    < -PR_MIN_MODEL_DISTANCE => VISUAL_HEBREW_NAME,
                    _ => finalSub < 0
                        ? VISUAL_HEBREW_NAME
                        :
                        // (finalDub > 0 - Logical) or (don't know what to do) default to Logical.
                        LOGICAL_HEBREW_NAME
                };
    ...
    {
        return b is PR_FINAL_KAF or PR_FINAL_MEM or PR_FINAL_NUN or PR_FINAL_PE or PR_FINAL_TSADI;
    }
    #endregion
    ...
    protected static bool IsNonFinal(byte b)
    {
        ...
        // are quite rare.            
        return b == PR_NORMAL_KAF || b == PR_NORMAL_MEM || b == PR_NORMAL_NUN
               || b == PR_NORMAL_PE;
    }
    #endregion
}